...
for table in [Groups, ThermoLibraries, ThermoDepositories]:
...
class ThermoData(SCHEMA_BASE):
    ...
    # Store arrays of 7 as flattened columns for simplicity
    Tdata_1 = Column(Float); Tdata_2 = Column(Float); Tdata_3 = Column(Float)
    Tdata_4 = Column(Float); Tdata_5 = Column(Float); Tdata_6 = Column(Float); Tdata_7 = Column(Float)
    
    Cpdata_1 = Column(Float); Cpdata_2 = Column(Float); Cpdata_3 = Column(Float)
    Cpdata_4 = Column(Float); Cpdata_5 = Column(Float); Cpdata_6 = Column(Float); Cpdata_7 = Column(Float)
...
class Nasa(SCHEMA_BASE):
    ...
    Tmin = Column(Float); Tmax = Column(Float); T_unit = Column(String)
    E0 = Column(Float); E0_unit = Column(String)
    Cp0 = Column(Float); Cp0_unit = Column(String)
    CpInf = Column(Float); CpInf_unit = Column(String)
...
class NasaPolynomial(SCHEMA_BASE):
    ...
    c1 = Column(Float); c2 = Column(Float); c3 = Column(Float); c4 = Column(Float)
    c5 = Column(Float); c6 = Column(Float); c7 = Column(Float)
    Tmin = Column(Float); Tmax = Column(Float); T_unit = Column(String)
